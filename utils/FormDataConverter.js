/**
 * Service to convert Form model to JSON structure for comparison
 */
class FormDataConverterService {
     ...
     * @returns {Object} JSON object with only form sections
     */
    convertPlainObjectToJSON(plainObject) {
        const formData = {};
        const sections = this.getFormSections();
...
module.exports = new FormDataConverterService();